...
router.route('/products/new').post(isAunthenticatedUser, authorizeRoles('admin'), upload.array('images', 5), newProduct);
...
router.route('/admin/product/new').post(isAunthenticatedUser, authorizeRoles('admin'), upload.array('images', 5), newProduct);
