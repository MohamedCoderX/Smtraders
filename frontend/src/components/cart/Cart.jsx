...
export default function Cart () {
    ...
    const increaseQty = (item) => {
        ...
        dispatch(increaseCartItemQty({ product: item.product, quantity: item.quantity + 1 }));
    };
                                ...
                                <Fragment key={item.product}>
                                    ...
                                    <div className="cart-item">
                                        <div className="row  align-items-center justify-content-center">
                                            ...
                                            <div className="col-4 col-lg-2 mt-4 mt-lg-0 p-0 text-center mb-0">
                                                <p id="card_item_price">&#x20B9;{item.price}</p>
                                            </div>

                                            <div className="col-4 col-lg-3 mt-4 mt-lg-0 p-0 text-center">
                                            ...
                                            <div className="col-4 col-lg-1 mt-4 mt-lg-0 text-center p-0
                                            ">
